...
class AddBook(Toplevel):
   def __init__(self):
    ...
    #Heading,image,
    self.top_image=PhotoImage(file='dabok.png')
    ...
    self.ent_language = Entry(self.bottomFrame, width=30, bd=3)
    self.ent_language.insert(0, 'Please enter a language')
    self.ent_language.place(x=150, y=165)
    #Button
    button=Button(self.bottomFrame,text='Add Books',command=self.addBook)
