...
class Main(object):
    def __init__(self, master):
        ...
        #searchbar
        search_bar=LabelFrame(centerRightFrame,width=440,height=75,text='Search Bar',bg='#9bc9ff')
        search_bar.pack()
        self.lbl_search=Label(search_bar,text='Search :',font='arial 12 bold',bg='#9bc9ff',fg='purple')
        ...
        #listbar
        list_bar = LabelFrame(centerRightFrame,width=440,height=175,text='List Box',bg='#cfd15e')
        list_bar.pack(fill=BOTH)
        lbl_list=Label(list_bar,text='Sort by',font='times 16 bold',fg='#db5a51',bg='#cfd15e')
        lbl_list.grid(row=0,column=2)
        self.listChoice=IntVar()
        rb1 = Radiobutton(list_bar, text='All Books', var=self.listChoice,value=1,bg='#cfd15e')
        rb2 = Radiobutton(list_bar, text='In Library', var=self.listChoice, value=2, bg='#cfd15e')
        rb3 = Radiobutton(list_bar, text='Borrowed Books', var=self.listChoice, value=3, bg='#cfd15e')
    ...
    ##################################TOOL_BAR###########################################
        #add book
        self.iconbook=PhotoImage(file='add.png')
        ...
        #add member button
        self.iconmember=PhotoImage(file='add member.png')
        ...
        #give book
        self.icongive=PhotoImage(file='lent.png')
        self.btngive=Button(topFrame,text='Lend Book',font='arial 12 bold',padx=10,image=self.icongive,compound=LEFT,command=self.giveBook)
        self.btngive.pack(side=LEFT)
#################################Tabs#########################################
    ##################Tab1###############################
        self.tabs=ttk.Notebook(centerLeftFrame,width=900,height=660)
        self.tabs.pack()
        self.tab1_icon = PhotoImage(file='sta.png')
        self.tab2_icon = PhotoImage(file='stat.png')
        ...
        #List books
        self.list_books=Listbox(self.tab1,width=40,height=30,bd=3,font='times 12 bold')
        ...
        #listdetails
        self.list_details=Listbox(self.tab1,width=80,height=30,bd=3,font='times 12 bold')
...
class GiveBook(Toplevel):
    def __init__(self):
        ...
        # Button
        button = Button(self.bottomFrame, text='Lend Books',command=self.lendBook)
    ...
    def lendBook(self):
        ...
        if(book_name and member_name !=""):
            try:
                query="INSERT INTO 'borrows' (bbook_id,member_id) VALUES(?,?)"
...
def main():
    ...
    root.geometry("1350x650+100+100")
    p1 = PhotoImage(file='library.png')
